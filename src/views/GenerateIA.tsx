...
export default function GenerateAI() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) =>{
       ...
       const prompt = form.get('prompt') as string // al hacer click en submit crea un form data y mapea con los campos de 'prompt'
        ...
        >
          <div className="relative">
            ...
            <button 
              type="submit" 
              aria-label="Enviar"
              className={`cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2 ${isGenerating ? "cursor-not-allowed opacity-55" : ""}`}
